              ...
              <div class="col-lg-6 d-flex ">
                <div class="member flex-grow-1 d-flex flex-column align-items-start">
                  ...
                  <div class="member-info">
                    ...
                    <br>
                    <br>
                    <h5>Terwujudnya masyarakat sehat yang melek digital melalui telemedicine</h5>
                  </div>
                </div>
              </div>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-3">
            <div class="icon-box" >
              <img src="assets/img/hs/fitur/chatdokter.png" alt="Chat Dokter" >
              <p>Chat Dokter</p>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-6">
            <div class="icon-box" >
              <img src="assets/img/hs/fitur/catatan.png" alt="Catatan & Resep Obat" >
              <p>Catatan & Resep Obat</p>
            </div>
          </div>

          <div class="col-lg-3 col-md-6">
            <div class="icon-box" >
              <img src="assets/img/hs/fitur/statistik.png" alt="Statistik Pengguna" >
          ...
          <div class="col-lg-3 col-md-6">
            <div class="icon-box">
              <img src="assets/img/hs/fitur/billing.png" alt="Billing & Validasi Otomatis" >
              <p>Billing & Validasi Otomatis</p>
            </div>
          </div>
